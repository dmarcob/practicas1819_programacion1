...
struct Alumno {
    private:
        ...
        ... deben definirse aquí los campos de un dato de tipo Alumno ...
    public:
...
struct Grupo {
    private:
        // Estructura interna de un dato de tipo Alumno
        ... deben definirse aquí los campos de un dato de tipo Grupo ...
    public:
...
struct Notas {
    private:
        ...
        ... deben definirse aquí los campos de un dato de tipo Notas ...
    public:
